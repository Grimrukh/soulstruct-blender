...
def average_vert_facedata(bm: bmesh.types.BMesh, verts: list[bmesh.types.BMVert] | BMVertSeq = []):
...
def beautify_fill(
    ...
    faces: list[bmesh.types.BMFace] | BMFaceSeq = (),
...
def connect_vert_pair(
    bm: bmesh.types.BMesh,
    verts: list[bmesh.types.BMVert] | BMVertSeq = (),
    verts_exclude: list[bmesh.types.BMVert] | BMVertSeq = (),
    faces_exclude: list[bmesh.types.BMFace] | BMFaceSeq = (),
) -> dict[str, typing.Any]:
...
def connect_verts_concave(
    bm: bmesh.types.BMesh, faces: list[bmesh.types.BMFace] | BMFaceSeq = ()
) -> dict[str, typing.Any]:
...
def connect_verts_nonplanar(
    bm: bmesh.types.BMesh, angle_limit: float = 0, faces: list[bmesh.types.BMFace] | BMFaceSeq = ()
) -> dict[str, typing.Any]:
...
def dissolve_faces(
    bm: bmesh.types.BMesh, faces: list[bmesh.types.BMFace] | BMFaceSeq = (), use_verts: bool = False
) -> dict[str, typing.Any]:
    """Dissolve Faces.
...
def find_doubles(
    bm: bmesh.types.BMesh,
    verts: list[bmesh.types.BMVert] | BMVertSeq = (),
    keep_verts: list[bmesh.types.BMVert] | BMVertSeq = (),
    dist: float = 0,
) -> dict[str, typing.Any]:
...
def flip_quad_tessellation(bm: bmesh.types.BMesh, faces: list[bmesh.types.BMFace] | BMFaceSeq = ()):
...
def recalc_face_normals(bm: bmesh.types.BMesh, faces: list[bmesh.types.BMFace] | BMFaceSeq = ()):
...
def remove_doubles(
    bm: bmesh.types.BMesh, verts: list[bmesh.types.BMVert] | BMVertSeq = (), dist: float = 0
):
...
def reverse_colors(
    bm: bmesh.types.BMesh, faces: list[bmesh.types.BMFace] | BMFaceSeq = (), color_index: int = 0
):
...
def reverse_uvs(bm: bmesh.types.BMesh, faces: list[bmesh.types.BMFace] | BMFaceSeq = ()):
...
def rotate_uvs(
    bm: bmesh.types.BMesh, faces: list[bmesh.types.BMFace] | BMFaceSeq = (), use_ccw: bool = False
):
...
def unsubdivide(
    bm: bmesh.types.BMesh, verts: list[bmesh.types.BMVert] | BMVertSeq = (), iterations: int = 0
):
