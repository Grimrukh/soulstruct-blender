...
from soulstruct.blender.msb.properties.parts import BlenderMSBPartSubtype, MSBCharacterProps
...
@soulstruct_adapter
class BlenderMSBCharacter(BaseBlenderMSBPart_DES[MSBCharacter, MSBCharacterProps]):
