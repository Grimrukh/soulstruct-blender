"""Node tree builder for Bloodborne."""
...
class NodeTreeBuilder(BaseNodeTreeBuilder):
    """Node tree builder for Bloodborne (2015).

    TODO: Currently the same as PTDE.
    """
    ...
    def build(self) -> None:
        ...
        try:
            ...
            if "NormalToAlpha" in self.matdef.shader_stem:
                ...
                return
            if re.match(r"SRPJ_(Foliage|Ivy|Phn)_ColDif.*", self.matdef.shader_stem):
