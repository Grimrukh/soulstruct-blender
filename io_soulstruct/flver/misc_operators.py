...
class ActivateUVTexture0(ActivateUVMap):
    ...
    bl_description = "Set the UV Editor texture to 'UVTexture0', usually the first normal texture"
...
class ActivateUVTexture1(ActivateUVMap):
    ...
    bl_description = "Set the UV Editor texture to 'UVTexture1', usually the second normal texture"
