...
if tp.TYPE_CHECKING:
    ...
    MSB_MAPPIECE_TYPING = tp.Union[PTDE_MSBMapPiece, DS1R_MSBMapPiece, BB_MSBMapPiece, ER_MSBMapPiece]
    ...
    MSB_COLLISION_TYPING = tp.Union[PTDE_MSBCollision, DS1R_MSBCollision, BB_MSBCollision, ER_MSBCollision]
    ...
    MSB_NAVMESH_TYPING = tp.Union[PTDE_MSBNavmesh, DS1R_MSBNavmesh, BB_MSBNavmesh]
    ...
    MSB_CHARACTER_TYPING = tp.Union[PTDE_MSBCharacter, DS1R_MSBCharacter, BB_MSBCharacter, ER_MSBCharacter]
    ...
    MSB_OBJECT_TYPING = tp.Union[PTDE_MSBObject, DS1R_MSBObject, BB_MSBObject]

    from soulstruct.eldenring.maps.parts import MSBAsset as ER_MSBAsset
    MSB_ASSET_TYPING = tp.Union[ER_MSBAsset]
